...
public class ListaEquipaje {
    ...
    public String imprimirG(){
        ...
        do {
            if (actual!=null) {
                Adatos=Adatos+"nodo"+mal+"[label=\""+actual.getDatos()+"\"];\n";
                if (actual==primero) {
                    Adatos=Adatos+"nodo"+mal+"->nodo"+male+"\n";
                    Adatos=Adatos+"nodo"+male+"->nodo"+mal+"\n";
                    mal++;
                    male++;
                }
                if (actual!=ultimo && actual!=primero) {
                    Adatos=Adatos+"nodo"+mal+"->nodo"+male+"\n";
                    Adatos=Adatos+"nodo"+male+"->nodo"+mal+"\n";
                    mal++;
                    male++;
        ...
        if (!estaVacia()) {
            Adatos=Adatos+"nodo"+0+"->nodo"+mal+"\n";
            Adatos=Adatos+"nodo"+mal+"->nodo"+0+"\n";
        }
        if(estaVacia()){
            Adatos="digraph E {\n";
        }
